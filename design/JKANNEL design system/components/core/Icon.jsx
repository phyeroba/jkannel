...
/* The JKANNEL icon set, ported from frontend/src/components/AppIcon.vue.
   24x24 line glyphs, stroke: currentColor, stroke-width 1.7. */
export const ICONS = {
...
export function Icon({ name, size = 18, style, ...rest }) {
  return (
    <svg
      ...
      aria-hidden="true"
      style={style}
      dangerouslySetInnerHTML={{ __html: ICONS[name] || ICONS.cog }}
      {...rest}
    />
  );
}
