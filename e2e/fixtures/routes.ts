...
export const workspaceRoutes: WorkspaceRoute[] = [
  ...
  { label: 'Live Traffic', path: '/live-traffic', root: 'live-traffic-view' },
  { label: 'Queues', path: '/queues', root: 'module-workspace' },
  { label: 'DLR Performance', path: '/dlr-performance', root: 'dlr-performance-view' },
  ...
  { label: 'Failover', path: '/failover', root: 'failover-view' },
  { label: 'Route Simulator', path: '/route-simulator', root: 'route-simulator-view' },
  { label: 'Message Trace', path: '/message-trace', root: 'message-trace-view' },
  { label: 'SMPP Errors', path: '/smpp-errors', root: 'smpp-errors-view' },
  { label: 'Events', path: '/events', root: 'events-view' },
  { label: 'Test Tools', path: '/test-tools', root: 'test-tools-view' },
