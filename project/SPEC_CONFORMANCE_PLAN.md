...
- **Wave 4 — in progress.** REST/OpenAPI auto-generation + cursor pagination + field selection; data-model completeness (partitioning/archive, soft-delete, optimistic locking, audit signatures); fuller Docker topology (nginx, loki/promtail, watchdog, scheduler, backup-service, hardening).
