...
> **Normative contract update (2026-07-06):** This document defines the upstream Kannel adapter only. It does not define Kamex behavior or capability parity. `ENGINE_ADAPTER_CONTRACT.md`, `ENGINE_CAPABILITY_REGISTRY.md`, and ADR-0007 take precedence for core versus optional operations, sibling adapter selection, capability provenance, and unsupported results.
