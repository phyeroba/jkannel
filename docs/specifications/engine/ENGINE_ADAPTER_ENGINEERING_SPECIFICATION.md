...
> **Normative contract update (2026-07-06):** `ENGINE_ADAPTER_CONTRACT.md`, `ENGINE_CAPABILITY_REGISTRY.md`, and ADR-0007 govern heterogeneous engines. Methods described below beyond identity, capability discovery, transport health, and adapter self-diagnostics are optional capability-scoped provider operations. They are not mandatory parity requirements.
